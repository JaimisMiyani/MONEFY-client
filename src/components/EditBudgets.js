                    ...
                    <div className="mx-auto" style={{ border: '1px solid black' }}>
                        ...
                        <div className='centered'>
                            <div className='card text-dark mb-3' style={{ backgroundColor: '#d6efc7' }}>
                                <div className='card-header setShadow' style={{ backgroundColor: '#184d47', color: '#fff' }}>Budgets</div>
                                <div className='card-body'>
                                    <table>
                                        <tr style={{ border: 'none' }}>
                                            ...
                                            <td style={{ textAlign: 'center' }}><button className='btn btn-success btn-sm' style={{ color: '#fff', backgroundColor: '#184d47' }} onClick={(e) => {

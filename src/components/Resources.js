...
const Resources = () => {
    return (
        <div className="mx-5 my-3">
            <div className="card">
                <h5 className='shadow-sm m-2 p-3 rounded'>Let's get you known about Investment in India. Why Investing is Important & Where to Invest?</h5>
                <p className='shadow-none m-2 p-3 rounded'>Investing is allocating money towards assets in the hope of making your future better. Investments are made with the view of earning returns, which grows your amount invested to a higher sum.</p>
                <h3 className='shadow m-2 p-3 rounded'>Why Should You Invest?</h3>
                <p className='shadow-none m-2 p-3 rounded'>Investing is essential to achieve your goals. It is the only way to make your future better. By making investments, you are also saving and accumulating a corpus for a rainy day. Apart from that, making regular investments forces you to set aside a sum regularly, thereby helping you instil a sense of financial discipline in the long run. </p>
                <h3 className='shadow m-2 p-3 rounded'>Impact of Inflation and the Importance of Investing</h3>
                <p className='shadow-none m-2 p-3 rounded'>Inflation, in simple terms, is a surge in the price of materials and services. It decreases the worth of your money and reduces your purchasing power. When there is a rise in the inflation rate, you buy fewer things with the same amount of money. You have no control over the inflation rate. If you are to stay ahead of inflation, you need to have more money to purchase the extent of the goods you intend to in the future with the money you have today. But, money doesn’t grow on its own. If your money has to grow, then it has to earn returns. To earn returns, you need to invest. Therefore, making investments is necessary to tackle inflation. Inflation at the rate of 8% means that you need 8% more money than what you have to purchase the same item next year. Here’s how inflation at 8% reduces the worth of Rs 1 lakh over eight years:</p>
                <table className='text-center tableBorder m-2' style={{width : '99%'}}>
                    <tr>
                        <td>Amount in hand now</td>
                        <td>Rs 1,00,000</td>
                    </tr>
                    <tr>
                ...
                <p className='shadow-none m-2 p-3 rounded'>You have to choose to adopt either an active or passive strategy after you have assessed your requirements and risk tolerance level. </p>
                <h3 className='shadow m-2 p-3 rounded'>Popular Investment Options in India</h3>
                <p className='shadow-none m-2 p-3 rounded'>You have numerous investment options to choose from. However, you have to ensure that you are investing in only those options that fall under your risk tolerance and serve your requirements. The following are the top 7 investment options in India:
                ...
                <h3 className='shadow m-2 p-3 rounded'>Which Investment Option Should You Choose?</h3>
                <p className='shadow-none m-2 p-3 rounded'>Since there are numerous investment vehicles, it is normal for an investor to get stuck when selecting one. If you are new to investing, then it is likely that you are not sure as to where you should invest your money. Making the wrong investment choice can lead to financial losses, which you would not want. Hence, we recommend that you base your investment decisions on the following parameters:
                    <ul className='list-group list-group-flush'>
                ...
                <h3 className='shadow m-2 p-3 rounded'>How should I plan my investments?</h3>
                <p className='shadow-none m-2 p-3 rounded'>The first step in planning your investments is to figure out the right investment that fits your profile and needs. Here are a few things to keep in mind when planning your investments:
                    <ul className='list-group list-group-flush'>
                ...
                <h3 className='shadow m-2 p-3 rounded'>The sooner you start, the better</h3>
                <p className='shadow-none m-2 p-3 rounded'>You should get started with your investments as soon as possible. When it comes to investments, time is money. The sooner you get started, and longer you stay invested, the more returns you earn on your investments. Consider the following example. Suppose you start investing Rs 1 lakh a year from the time you turn 25 years old and continue to do so until you turn 58 years, along with your brother who is already 35 years old. Consider you both invest in a scheme which offers returns at 10% a year. Let’s compare how your investments rack up against one another upon maturity:</p>
                <table className='text-center tableBorder m-2' style={{width : '99%'}}>
                    <tr>
                        <th scope='col'>Age</th>
                        <th scope='col'>You start at the of age of 25 years</th>
                        <th scope='col'>Your brother starts at the age of 35 years</th>
                    </tr>
                    <tr>
                        <td>25</td>
                        <td>Rs 1,10,000</td>

...
const Tips = () => {
    return (
        <div style={{ margin: '10px' }}>
            <h5 className='shadow-sm p-3 rounded'>Top tips for choosing investments</h5>
            <p className='shadow-none p-3 rounded'>Use these tips and key steps to help find an investment that’s right for you.</p>
            <h3 className='shadow p-3 rounded'>1. Review your needs and goals</h3>
            <p className='shadow-none p-3 rounded'>It’s well worth taking the time to think about what you really want from your investments. Knowing yourself, your needs and goals and Your appetite for risk is a good start, so start by filling in a Money fact find.</p>
            <h3 className='shadow p-3 rounded'>2. Consider how long you can invest</h3>
            <p className='shadow-none p-3 rounded'>Think about how soon you need to get your money back. Time frames vary for different goals and will affect the type of risks you can take on. For example:

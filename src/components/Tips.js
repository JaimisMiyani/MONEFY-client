            ...
            <div className="card" style={{border:'none'}}>
                <div className="card-header">
                    <ul className="nav nav-tabs card-header-tabs">
                        ...
                        <li className="nav-item">
                            <a className="nav-link active scolor1" href="./tips">Financial Tips</a>
                        </li>
                    </ul>
                </div>
                <div className="card-body">
                    <div className="mx-auto" style={{ border : '1px solid black' }}>
                        <h5 className='shadow-sm m-2 p-3 rounded'>Top tips for choosing investments</h5>
                        <p className='shadow-none m-2 p-3 rounded'>Use these tips and key steps to help find an investment that’s right for you.</p>
                        <h3 className='shadow m-2 p-3 rounded'>1. Review your needs and goals</h3>
                        <p className='shadow-none m-2 p-3 rounded'>It’s well worth taking the time to think about what you really want from your investments. Knowing yourself, your needs and goals and Your appetite for risk is a good start, so start by filling in a Money fact find.</p>
                        <h3 className='shadow m-2 p-3 rounded'>2. Consider how long you can invest</h3>
                        <p className='shadow-none m-2 p-3 rounded'>Think about how soon you need to get your money back. Time frames vary for different goals and will affect the type of risks you can take on. For example:
